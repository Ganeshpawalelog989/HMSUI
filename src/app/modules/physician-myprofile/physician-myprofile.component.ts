...
@Component({
  selector: 'app-physician-myprofile',
  templateUrl: './physician-myprofile.component.html',
  styleUrls: ['./physician-myprofile.component.scss']
})
export class PhysicianMyprofileComponent implements OnInit {
  regiForm!: FormGroup;
  submitted = false;
  register: any;
