...
@Component({
  selector: 'app-adminpatientregistration',
  templateUrl: './adminpatientregistration.component.html',
  styleUrls: ['./adminpatientregistration.component.scss']
})
export class AdminpatientregistrationComponent implements OnInit {
